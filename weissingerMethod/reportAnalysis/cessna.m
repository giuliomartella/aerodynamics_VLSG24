...
wingC.twistPrime = deg2rad(2.0);
wingC.twistZero = deg2rad(0.0);
...
% define precision
wingC.discretize = [30; 30]; % singularities in [chord direction; spanwise direction]



% data
tailC.ID = 2;
tailC.xOffset = [4.88; -0.5; 0.0];
...
% define precision
tailC.discretize = [20; 30]; % singularities in [chord direction; spanwise direction]
